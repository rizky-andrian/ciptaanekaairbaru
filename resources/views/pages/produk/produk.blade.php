                    ...
                    @foreach ($katProduk as $item)
                        <div class="h-48 bg-slate-50 drop-shadow-lg rounded-3xl overflow-hidden relative ">
                            ...
                            <a href="/products/kategori/{{ $item->slugs }}"
                                class="absolute top-0 flex flex-col justify-end h-48 w-full px-6">
                                <div
                                    class=" {{-- bg-caa-primary bg-opacity-60 text-white --}} bg-transparent text-black hover:text-white hover:bg-caa-primary font-bold hover:drop-shadow-xl w-full rounded-2xl ">
